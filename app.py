...
def start():
    ...
    if not cap.isOpened():
        return render_template('home.html', totalreg=totalreg(), datetoday2=datetoday2(),
                               mess='Unable to access the camera. Please make sure the camera is connected and not being used by other applications.')
    ...
    while True:
        ...
        # Extract faces and perform face recognition
    ...
    # Extract attendance and display the home page with updated data
    names, rolls, times, l = extract_attendance()
